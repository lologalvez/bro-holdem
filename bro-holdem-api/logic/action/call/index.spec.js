...
describe('logic - action - call', () => {
    ...
    it('should succeed on correct data', async () => {
        const result = await logic.call(gameId, twoId)
        ...
        expect(lastAction[0].type).to.equal('call')
