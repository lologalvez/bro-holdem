...
describe('logic - action - raise', () => {
    ...
    it('should succeed on correct data', async () => {
        const result = await logic.raise(gameId, twoId, raiseTo)
    ...
    it('should fail if game does not exist', async () => {
        ...
        try {
            await logic.raise(gameId, twoId, raiseTo)
        } catch (error) {
