...
describe.only('logic - action check', () => {
    ...
    it('should succeed on correct data', async () => {
        const response = await logic.actionCheck(gameId)
        ...
        expect(lastAction[0].type).toBe('check')
    ...
    it('should fail on incorrect token', async () => {
        logic.__token__ = '123'
        try {
            await logic.actionCheck(gameId)
        } catch (error) {
    ...
    it('should fail on incorrect gameId', async () => {
        ...
        try {
            await logic.actionCheck(_gameId)
        } catch (error) {
            expect(error).toBeDefined()
